...
<!-- Paula
Talk about functional disease clustering in general.
Then talk about how the bsfc package is useful to detect clusters.
Then put this paragraph about a particular example in disease mapping.
-->
...
<!-- Paula
Add how to install the development version of the package from GitHub.
-->

<!-- Paula
Add that you need INLA and say how to install it
-->
# Installation
...
<!-- Paula
Add spatial and temporal resolution of the data.
Add the original source of the data
-->
